...
func (m *JournalEditorModel) jumpWordBackward() {
	content := m.textarea.Value()
	if content == "" {
		return
	}
...
func (m *JournalEditorModel) jumpWordForward() {
	content := m.textarea.Value()
	if content == "" {
		return
	}
...
func (m *JournalEditorModel) deleteWordBackward() {
	content := m.textarea.Value()
	if content == "" {
		return
	}
...
func (m *JournalEditorModel) deleteWordForward() {
	content := m.textarea.Value()
	if content == "" {
		return
	}
